                        ...
                        <div class="row list-row list-index">
                            @foreach($users as $user)
                                @if(!$user->beats->isEmpty())
                                 ...
                                 <a href="#" class="slide-toggle d-block w-100" id="{{ $user->id }}"> {{ $user->name }} {{$user->beats->count()}}</a>
...
{{--                                        <span class="text-decoration-underline" style="color: #b83cb8; text-decoration: underline">You Have no Un-Reviewed Beats</span>--}}
{{--                                    </a>--}}
{{--                                </div>--}}
